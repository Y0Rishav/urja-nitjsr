...
const Hyperspeed = ({
  effectOptions = {
    ...
    colors: {
      // Deep dark road/background tones
      roadColor: 0x050505,
      islandColor: 0x080808,
      background: 0x000000,

      // Line colors (keep high contrast)
      shoulderLines: 0xffffff,
      brokenLines: 0xffffff,

      // Warm (left) and cool (right) car light palettes to match the provided UI
      leftCars: [0xff6a00, 0xff2d00, 0xffd200], // oranges/reds/yellow
      rightCars: [0x00c7ff, 0x1e90ff, 0x0066cc], // cyan/blue shades

      // Alternating sticks: warm and cool so the roadside lighting echoes the split UI
      sticks: [0xff6a00, 0x00c7ff]
    }
  }
}) => {
